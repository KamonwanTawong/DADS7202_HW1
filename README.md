...
## CONCLUSION
From evaluate the model on test set, we can see that from the prediction result, the precision that the model will be able to classify drinkability: Indicates whether the water is safe for human consumption. The total average is about 66%
